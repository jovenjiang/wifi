...
static int nl80211_mgmt_subscribe_non_ap(struct i802_bss *bss)
{
	...
	if (nl80211_alloc_mgmt_handle(bss))
		return -1;
	wpa_printf(MSG_DEBUG, "JJJnl80211_mgmt_subscribe_non_ap(struct i802_bss *bss)JJJ::nl80211: Subscribe to mgmt frames with non-AP "
...
//		WLAN_FC_STYPE_BEACON,
	...
	if (nl80211_alloc_mgmt_handle(bss))
		return -1;
	wpa_printf(MSG_DEBUG, "JJJstatic int nl80211_mgmt_subscribe_ap(struct i802_bss *bss)JJJ::nl80211: Subscribe to mgmt frames with AP "
		   "handle %p", bss->nl_mgmt);
...
static int nl80211_mgmt_subscribe_ap_dev_sme(struct i802_bss *bss)
{
	if (nl80211_alloc_mgmt_handle(bss))
		return -1;
	wpa_printf(MSG_DEBUG, "JJJstatic int nl80211_mgmt_subscribe_ap_dev_sme(struct i802_bss *bss)JJJ::"
				  ...
				  int offchanok)
{
	...
	msg = NULL;
	if (ret) {
		wpa_printf(MSG_DEBUG, "JJJ in nl80211_send_frame_cmd() "
				"ret = send_and_recv_msgs(drv, msg, cookie_handler, &cookie) JJJ::");
